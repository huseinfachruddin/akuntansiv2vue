<template>
  <div class="app-container" style="width:100%; box-shadow:2">
    ...
    <el-date-picker v-model="end" style="margin-left:8px;width:140px; margin-bottom:10px" class="filter-item" type="date" placeholder="Tanggal" />
...
export default {
  ...
  methods: {
    ...
    async handleFilterByDate() {
      ...
      const year = new Date(this.end).getFullYear()

      var dateStr = '01' + '/' + '01' + '/' + 1000

      const start_date = new Date(dateStr)
